...
public class HttpRequestHandler {
    ...
    private final long maxConnectionsNum = 10000;
    ...
    public HttpRequestHandler(ServerSettings settings, int connectionNum) {
    ...
    private void initFileResponse() {
        ...
        try {
            String filePath = (settings.getWwwRoot() + request.path).replace("/", File.separator);
